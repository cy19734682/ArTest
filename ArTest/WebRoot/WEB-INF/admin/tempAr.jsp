...
<head>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
 	<title>资源审核 - AR后台管理系统</title>
  <meta name="description" content="资源审核">
  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">资源管理</strong> / <small>资源审核列表</small></div>
      </div>
						...
						<tr>
						  <td class="center arIds">
							...
							<td>
							 <div class="am-btn-toolbar">
                  			  <div class="am-btn-group am-btn-group-xs">
		                     	<button type="button" onclick="shenhe(${l.arId});" class="am-btn am-btn-default am-btn-xs am-text-secondary">
            ...
            <div class="am-cf">
              ...
              <div class="am-fr">
                 <div data-am-page="{pages:${bkResult.data.pageLists.pageCount},curr:${bkResult.data.pageLists.currentPage}
                 		,jump:'admins/listAr?keyword=${bkResult.data.filterResult.keyword}&pagenow=%page%&state=1'}">
           		 </div>
              </div>
            </div>
          </form>
...
<script type="text/javascript">
	...
	function  shenhe(arId){
		  $.ajax({
		        url: "admins/updateArState",
		        dataType: "json",
		        type: "post",
		        data:{"arIds":arId,"state":0,"type":1} ,
		        success: function (data) {
		           if(data.status==0){
		             layer.alert(data.msg, {
							  closeBtn: 0
							}, function(){
						  window.location.href = "admins/listAr?state=1";
						});
		           }else{
		              layer.alert(data.msg);
		           }

...
public class ImageKit {
	...
	public static byte[] abscut(BufferedImage bi, String outputFile, String type, int x, int y, int destWidth,
     ...
     /*  String base64PreImg  = Constants.getFlexImgString(type,Base64.encode(b));
       System.out.println(base64PreImg);*/
        ImageKit.delFile(temp);
        	 return  b;  
        }
     ...
     * @return 返回处理后的图像
     */
    public static String zoomImage(String webPath,File srcfile, String type, int toWidth, int toHeight) {
        ...
        try {
           ...
           /* if (toHeight > Integer.valueOf(ReadSettingProperties.getValue("configicon.properties", "water_scope") )&& toWidth > Integer.valueOf(ReadSettingProperties.getValue("water_scope"))) {
                ImageKit.addWaterMark(webPath + File.separator + output, webPath
                        + File.separator + ReadSettingProperties.getValue("water"), toWidth, toHeight, 1.0f);
            }*/
            return output;
